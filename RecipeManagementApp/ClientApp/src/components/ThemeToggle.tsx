	...
	return (
		...
		>
			...
			<path
				...
				className={selected ? "stroke-violet-500" : "stroke-slate-400 dark:stroke-slate-500"}
			/>
		</svg>
	);
}
	...
	return (
		<svg viewBox="0 0 24 24" fill="none" {...props}>
			...
			<path
				...
				className={selected ? "fill-violet-500" : "fill-slate-400 dark:fill-slate-500"}
			/>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
	...
	return (
		<div className="flex items-center justify-between">
			...
			<div className="relative flex items-center p-2 font-semibold rounded-lg shadow-sm dark:highlight-white/5 text-slate-700 ring-1 ring-slate-900/10 dark:bg-slate-600 dark:text-slate-200 dark:ring-0">
				...
				<svg viewBox="0 0 24 24" fill="none" className="hidden w-6 h-6 mr-2 dark:block">
					<path
						fillRule="evenodd"
						clipRule="evenodd"
						d="M17.715 15.15A6.5 6.5 0 0 1 9 6.035C6.106 6.922 4 9.645 4 12.867c0 3.94 3.153 7.136 7.042 7.136 3.101 0 5.734-2.032 6.673-4.853Z"
